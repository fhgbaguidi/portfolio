...
\cvitem{\textbf{Cloud \& Ops}}{\textbf{Kubernetes}, \textbf{GitOps}, Docker, GitHub Actions, Terraform, GCP}
...
\begin{itemize}
    ...
    \item \textbf{Qualité :} Application stricte du \textbf{DDD} et de l'Onion Architecture. Stratégie de tests.
